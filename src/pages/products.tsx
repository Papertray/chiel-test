...
import {ProductsListComponent} from '@/components/Product/ProductList.tsx';
...
export default function Products() {
  const {data, isLoading, isSuccess} = useQuery<SamsungRequest>([SAMSUNG_API.name], fetchSamsungData);
    ...
    <div className="flex flex-col content-center bg-white h-full w-full overflow-y-scroll">
        <div className="h-fit bg-black">
          <div className="md:p-12 py-12 px-2 text-6xl">
            <p
              className="flex w-full text-4xl px-6 py-24 text-white self-center justify-center">Buy the coolest tech and explore</p>
          </div>
        </div>
        <div
